...
const HERO_VEHICLES = [
  { image: "/images/hero-scooter1.png", alt: "OMEV " },
  { image: "/images/hero-scooter2.png", alt: "OMEV Minato [OLA]" },
];
...
const STATS = [
  ...
  { icon: Store, value: "30+", label: "Dealers Across India" },
  ...
  return (
    <section className="relative overflow-hidden bg-neutral-950">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -right-24 top-0 h-[620px] w-[620px] rounded-full bg-gradient-to-br from-[#5fb129]/10 via-neutral-700/10 to-transparent blur-2xl" />
      </div>

      {/* Hero content — pt clears the fixed Navbar (h-16 / lg:h-20) */}
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-5 pb-14 pt-20 sm:gap-10 sm:px-6 sm:pb-16 sm:pt-24 lg:grid-cols-[1.05fr_1.3fr] lg:gap-6 lg:px-10 lg:pb-20 lg:pt-28">
        <div>
          <h1 className="text-3xl font-extrabold leading-[1.15] tracking-tight text-white sm:text-4xl md:text-5xl lg:text-[3.25rem] xl:text-6xl">
            Smarter Rides.
            <br />
            <span className="text-[#5fb129]">Greener India.</span>
            <br />
            Stronger Tomorrow.
          </h1>
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-neutral-400 sm:mt-5 sm:text-[15px]">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3 sm:mt-7">
            <Link
              href="/products"
              className="inline-flex items-center gap-2 rounded-full bg-[#437f1b] px-6 py-3 text-[13px] font-semibold uppercase tracking-wide text-white transition-colors hover:bg-[#5fb129]"
            >
              Explore OMEV
              <ArrowRight size={15} />
            </Link>
          ...
          <div className="mt-10 flex items-center gap-3 text-xs font-semibold text-neutral-500 sm:mt-14">
            <span className="text-white">
              {String(activeVehicle + 1).padStart(2, "0")}
            </span>
            <span className="relative h-px w-16 overflow-hidden bg-neutral-700">
              <span
                className="absolute inset-y-0 left-0 bg-[#5fb129] transition-all duration-700 ease-in-out"
                style={{
                  width: `${
        ...
        <div className="flex flex-col items-center">
          <div className="relative flex w-full items-center justify-center">
            <div className="relative aspect-square w-full max-w-[300px] sm:max-w-sm md:max-w-md lg:max-w-xl">
            ...
            {/* Stats overlay — only from sm upward, where there's room beside the image */}
            <div className="absolute -right-1 top-1/2 hidden -translate-y-1/2 flex-col gap-5 sm:flex sm:right-1 lg:-right-6 lg:gap-6">
              {HERO_STATS.map(({ icon: Icon, value, label }) => (
                <div key={label} className="flex items-center gap-2.5 lg:gap-3">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-neutral-700 bg-white text-black backdrop-blur lg:h-11 lg:w-11">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-neutral-400 lg:text-xs">{label}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Stats row — mobile only, below the carousel to avoid crowding the image */}
          <div className="mt-9 flex w-full max-w-xs items-center justify-center gap-6 sm:hidden">
            {HERO_STATS.map(({ icon: Icon, value, label }) => (
              <div key={label} className="flex flex-col items-center gap-1.5 text-center">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-neutral-700 bg-white text-black">
                  <Icon size={16} />
                </div>
                <div>
    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="mb-10 grid grid-cols-1 gap-6 lg:grid-cols-[0.9fr_2fr] lg:items-end">
          <div>
            <p className="mb-2 text-xs font-bold uppercase tracking-widest text-[#5fb129]">
              Our Lineup
            </p>
          ...
          <div className="flex flex-col gap-4 lg:items-end">
            ...
            <Link
              href="/products"
              className="inline-flex items-center gap-2 text-[13px] font-bold uppercase tracking-wide text-neutral-900 hover:text-[#5fb129]-600"
            >
              View all models
              <ArrowRight size={14} />
            </Link>
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="mt-1 text-2xl font-extrabold text-neutral-900">
                  {ride.name}
                  {ride.nameAccent && (
                    <span className="text-[#5fb129]"> {ride.nameAccent}</span>
                  )}
                </h3>
              ...
              <Link
                href={ride.href}
                className="absolute bottom-6 right-6 flex h-11 w-11 items-center justify-center rounded-full bg-neutral-900 text-white transition-colors group-hover:bg-[#5fb129] "
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-[0.9fr_2fr] lg:items-center lg:px-10">
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          {TECH_FEATURES.map(({ icon: Icon, title, desc }) => (
            <div key={title}>
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-[#5fb129]-700/50 text-[#5fb129]">
                <Icon size={20} />
              </div>
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-2 gap-8 px-6 lg:grid-cols-4 lg:px-10">
        {STATS.map(({ icon: Icon, value, label }) => (
          <div key={label} className="flex flex-col items-center gap-3 text-center">
            <Icon className="text-[#5fb129]" size={26} />
            <div>
    ...
    <section className="relative isolate overflow-hidden bg-neutral-950">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
        <div className="max-w-xl">
          <p className="mb-3 flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#5fb129]">
            <span className="h-px w-8 bg-[#5fb129]" />
            Life in Motion
          </p>
          <h2 className="text-3xl font-extrabold leading-tight tracking-tight text-white sm:text-4xl">
            Every Ride Tells
        ...
        <div className="mt-10 flex items-center gap-3">
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full border border-white/20 text-white transition-colors hover:border-[#5fb129] hover:text-[#5fb129]"
          >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          {TESTIMONIALS.map((t) => (
            ...
            >
              <Quote className="mb-4 text-[#5fb129]-600/30" size={32} fill="currentColor" />
    ...
    <section className="bg-white py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="mb-10 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-[13px] font-bold uppercase tracking-wide text-[#5fb129] hover:text-[#5fb129]/80"
          >
            View all articles
            <ArrowRight size={14} />
          </Link>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {BLOG_POSTS.map((post) => (
            <Link key={post.title} href={post.href} className="group">
              ...
              <h3 className="mt-1 text-[15px] font-bold leading-snug text-neutral-900 group-hover:text-[#5fb129]">
                {post.title}
              </h3>
              <span className="mt-2 inline-flex items-center gap-2 text-[13px] font-bold uppercase tracking-wide text-[#5fb129]">
                Read More
                <ArrowRight size={14} />
              </span>
            </Link>
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 px-6 lg:flex-row lg:items-center lg:px-10">
        <div>
          <h2 className="text-3xl font-extrabold leading-tight tracking-tight text-white sm:text-4xl">
            Ready to Experience
            <br />
            the <span className="text-[#5fb129]">Future?</span>
          </h2>
        ...
        <Link
          href="/test-ride"
          className="inline-flex shrink-0 items-center gap-2 rounded-full bg-[#5fb129] px-6 py-3.5 text-[13px] font-semibold uppercase tracking-wide text-white transition-colors hover:bg-[#5fb129]/80"
        >
          Book Your Test Ride
          <ArrowRight size={15} />
        </Link>
